...
### Technology - `HTML`, `CSS`, `Angular`,  and `Bootstrap`.

## Setup
```bash
$ git clone https://github.com/shubhampal39/E-Commerce-Application.git
$ cd shop
$ npm i
$ npm start
```
...
## Json server
 ...
 for more information see more(https://github.com/typicode/json-server)
